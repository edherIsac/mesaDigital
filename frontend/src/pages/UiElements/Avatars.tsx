...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | mesaDigital - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for mesaDigital - React.js Tailwind CSS Admin Dashboard Template"
      />
